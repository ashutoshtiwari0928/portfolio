...
export default function Hero() {
  return (
    <div className="bg-gray-950 text-white h-auto lg:h-screen md:px-12 lg:px-20  py-15">
      <div id="hero" className="flex flex-col lg:flex-row  ">
        {/* ===== Left Section ===== */}
      ...
      {/* ===== Skills Section ===== */}
      <div>
        <p className="font-mono text-sm md:text-base text-center lg:text-left py-6">
          Tools and Skills:
        </p>
        <section
          id="skills"
